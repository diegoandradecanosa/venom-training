        ...
        half *shared_mem_workspace)
{
    ...
    for(int m=0; m<load_mma_M; m++){
        ...
        for(int n=0; n<iter_mma_N; n++){
            ...
            result[0] = __float2half(cfrag[m*2  ][n].x[(metafrag[m][n].x[0] >> (pos*4) & 0x3)]);
            result[1] = __float2half(cfrag[m*2  ][n].x[(metafrag[m][n].x[0] >> (pos*4+2) & 0x3)]);
            result[2] = __float2half(cfrag[m*2  ][n].x[(metafrag[m][n].x[0] >> (pos*4+16) & 0x3)+4]);
            result[3] = __float2half(cfrag[m*2  ][n].x[(metafrag[m][n].x[0] >> (pos*4+18) & 0x3)+4]);
            result[4] = __float2half(cfrag[m*2+1][n].x[(metafrag[m][n].x[1] >> (pos*4) & 0x3)]);
            result[5] = __float2half(cfrag[m*2+1][n].x[(metafrag[m][n].x[1] >> (pos*4+2) & 0x3)]);
            result[6] = __float2half(cfrag[m*2+1][n].x[(metafrag[m][n].x[1] >> (pos*4+16) & 0x3)+4]);
            result[7] = __float2half(cfrag[m*2+1][n].x[(metafrag[m][n].x[1] >> (pos*4+18) & 0x3)+4]);
