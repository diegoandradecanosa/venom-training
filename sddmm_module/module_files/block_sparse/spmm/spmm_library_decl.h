...
DECL_FUNC(SpmmNM, 32, 64, 32, 32, 64, 32, 16, 8, 32, 3);
DECL_FUNC(SpmmNM, 32, 64, 32, 32, 64, 32, 16, 8, 32, 4);
...
DECL_FUNC(SpmmNM, 64, 64, 32, 64, 64, 32, 16, 8, 32, 2);
DECL_FUNC(SpmmNM, 64, 64, 32, 64, 64, 32, 16, 8, 32, 3);
DECL_FUNC(SpmmNM, 64, 64, 32, 64, 64, 32, 16, 8, 32, 4);
